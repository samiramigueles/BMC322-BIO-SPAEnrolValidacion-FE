...
function Welcome({ setStep, sessionid, step }) {
  ...
  const handleClick = () => {
    ...
    setStep(optionProcess === "E" || optionProcess === "W" ? validationStep.FRENTE_DNI : validationStep.SELFIE)
    ...
    <Layout step={step}>
        ...
        <Typography variant="h1" color={"primary"} fontSize={"1.3em"}>

          {
            optionProcess === "W" ?
              ...
              : `Hola, vamos a comenzar ${optionProcess === "E" || optionProcess === "W" ? "registrando" : "validando"} tu identidad`
          }
      ...
      >
        <Typography variant="h2" color={"primary"} width={"100%"}>
          {optionProcess === "E" || optionProcess === "W" ? " Solo necesitás estar en un lugar iluminado y con el DNI en mano." : "Solo necesitás estar en un lugar iluminado."}
